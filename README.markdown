# أمثلة على مبدأ المسؤولية الواحدة (SRP) بلغة C#
...
| 17 | ملف تعريف المستخدم والتصدير | [UserProfileViolate.cs](Examples/Example17/UserProfileViolate.cs) | [UserProfile.cs](Examples/Example17/UserProfile.cs) |
